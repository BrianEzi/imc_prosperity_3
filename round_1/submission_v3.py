...
class Trader:
    def __init__(self):
        ...
        self.resin_take_width = HYPERPARAMS['resin_take_width']         # Take width for Resin
        self.resin_mm_edge = HYPERPARAMS['resin_mm_edge']             # Market-making edge for Resin

        # Parameters for Kelp
        self.kelp_take_width = HYPERPARAMS['kelp_take_width']           # Take width for Kelp
        self.kelp_mm_edge = HYPERPARAMS['kelp_mm_edge']              # Market making edge for Kelp
        self.kelp_beta = HYPERPARAMS['kelp_beta']               # Smoothing parameter for dynamic fair value update

        # Parameters for Squid Ink
        self.squid_take_width = HYPERPARAMS['squid_take_width']          # Take width for Squid Ink (wider due to volatility)
        self.squid_mm_edge = HYPERPARAMS['squid_mm_edge']             # Market-making edge for Squid Ink
        self.squid_beta = HYPERPARAMS['squid_beta']              # Mean-reversion parameter for Squid Ink
        self.squid_vol_threshold = HYPERPARAMS['squid_vol_threshold']      # Maximum acceptable volume for immediate order taking
